                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-sm-6 clearfix">
                            <div class="user-profile pull-right" style="background:orange">
                                ...
                                <h3> Alarmas entrantes al taller </h3>
                                <br>
                    <div class="container">
                        ...
                        <table border="1px solid" class="table table-striped table-bordered" id="example">
                            ...
                            <tbody>
                                <tr>
                                    <td><%=list.get(i).getNombre() + " " + list.get(i).getApellido()%></td>
                                    <td><%=list.get(i).getNombreTaller()%></td>
                                    <td><%=list.get(i).getDireccion()%></td>
                                    <td><%=list.get(i).getFecha()%></td>
                                    <td><a href="/Propietario/controlador?action=aceptarAlarma&Alarma=<%=list.get(i).getIdAlarma()%>">aceptar</a></td>
                                </tr>
                            </tbody>
