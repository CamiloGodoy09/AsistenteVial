 ...
 * @author junior
 */
@WebServlet(name = "ActualizarClienteControlador", urlPatterns = {"/ActualizarCliente"})
public class ConsultarClienteControlador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ClienteVO clieVO = new ClienteVO(idCliente);
        ClienteDAO clieDAO = new ClienteDAO(clieVO);

        ClienteVO cVO = ClienteDAO.consultarUsuario(idCliente);
        if (cVO != null) {
