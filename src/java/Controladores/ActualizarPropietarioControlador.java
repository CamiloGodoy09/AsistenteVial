 ...
 * @author junior
 */
@WebServlet(name = "ActualizarPropietarioControlador", urlPatterns = {"/ActualizarPropietario"})
public class ActualizarPropietarioControlador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PropietarioVO propieVO = new PropietarioVO(idPropietario);
        PropietarioDAO propieDAO = new PropietarioDAO(propieVO);

        
        PropietarioVO pVO = propieDAO.consultarPropietario(idPropietario);
