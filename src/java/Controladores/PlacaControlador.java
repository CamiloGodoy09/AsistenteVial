 ...
 * @author junior
 */
@WebServlet(name = "ConsultarTallerControlador", urlPatterns = {"/ConsultarTaller"})
public class PlacaControlador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        VehiculoVO vehVO = new VehiculoVO(noPlaca);
