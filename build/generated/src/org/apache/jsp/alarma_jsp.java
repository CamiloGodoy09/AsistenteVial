...
public final class alarma_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
   ...
   BeanTaller bvtaller = new BeanTaller();
    ...
    for (int i = 0; i < lista.size(); i++) {
      ...
      out.write("\" id=\"idusuario\"/>       <!--[if lt IE 8]>\n");
 ...
 if (request.getAttribute("mensajeError") != null) { 
      ...
      out.write("                                    <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\n");
      out.write("                                    <strong>¡Correcto!</strong> Su vehiculo se registró correctamente.\n");
      out.write("                                </div>\n");
      out.write("                                ");
 }
      out.write("\n");
      ...
      out.write("                        <h4 class=\"header-title\">Generar Alarma</h4>\n");
      ...
      out.write("                                        });\n");
      out.write("                                        var defaultLayer = L.tileLayer.provider('OpenStreetMap.Mapnik').addTo(map);\n");
      out.write("\n");
      out.write("                                        ");
for (int i = 0; i < lista.size(); i++) {
                                                bvtaller = lista.get(i);
      ...
      out.print(i);
      out.write(" = L.marker([");
      out.print(bvtaller.getLatitud());
      out.write(',');
      out.write(' ');
      out.print(bvtaller.getLongitud());
      out.write("]);\n");
      out.write("                                        marker");
      out.print(i);
      ...
      out.print(bvtaller.getLongitud());
      out.write("])\n");
      out.write("                                                .setContent('<p>nombre: ");
      out.print(bvtaller.getNombreTaller());
      out.write("<br>telefono:  ");
      out.print(bvtaller.getTelefono());
      out.write("<br> direccion:");
      out.print(bvtaller.getDireccion());
      out.write("<br>correo:");
      out.print(bvtaller.getCorreo());
      out.write(" </p><br>\\n\\\n");
      out.write("                                    <button class=\"btn btn-warning\" onclick=\"traerId(this.value)\"class=\"alertar\" value=\"");
      out.print(bvtaller.getNiTaller());
      out.write("\" >Crear Alerta</button>')\n");
      out.write("\n");
      out.write("                                        marker");
      out.print(i);
      out.write(".addTo(map)\n");
