        ...
        <div class="page-container">
            ...
            <div class="main-content">
                ...
                <div class="page-title-area">
                    ...
                    <br>
                    <center>                    <h4>¡Bienvenido al Taller!</h4> 
                    </center>
                    <div class="row">
                        <div class="col-lg-6 mt-5">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title">¿Quieres que tu taller se de a conocer?</h4>
                                    <p>Con asistente vial esto ya no será un problema.</p>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p>Como propietario podrás dar a conocer tu taller con mayor facilidad, ya que los usuarios que se encuentren
                                                        registrados podrán saber sobre tu taller, solo con un click en la pantalla.
                                                    </p>
                                                </div>
                        ...
                        <div class="col-lg-6 mt-5">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title">¿Me beneficia Asistente Vial?</h4>
                                    <p>Aumenta tus ingresos y tus clientes.</p>
                                    <!-- Button trigger modal -->
                                    ...
                                    <div class="modal fade" id="precio">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title"> Aumento de clientes </h5>
                                                    <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                                                </div>
                                                <div class="modal-body">
                                                    <p>
                                                        Como propietario podrás ver como tu taller crece poco a poco , y tus clientes de confianza van aumentando,
                                                        y con esto la buena reputación y fama del taller.
                                                    </p>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
