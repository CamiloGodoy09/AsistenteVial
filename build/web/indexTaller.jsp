        ...
        <div class="">
            <div class="container">
                <div class="login-box ptb--100" >
                    <form method="post" action="loginUsuarios">         
                        ...
                        <div class="login-form-body">
                            ...
                            <div class="submit-btn-area">
                                ...
                                <div class="form-footer text-center mt-5">
                                    <p class="text-muted">No tienes cuenta? <a href="registroPropietario.jsp">Registrar</a></p>
                                </div>
                                -->
                                <div class="form-footer text-center mt-5">
                                    <p class="text-muted">Olvidaste la Clave <a href="recuperarClavePP.jsp">Recuperar</a></p>
                                </div>
                            </div>
                        </div>
                    </form>
